...
%                        & component (iii--v) ipfv & component (iii--v) pfv\\[1cm]
    ...
    \draw [decorate,decoration={brace, amplitude=10pt,raise=4pt}] (anchor-1) -- (anchor-3) node [midway,sloped,above=1.25em] {\scshape first layer};
    \draw [decorate,decoration={brace, amplitude=10pt,raise=4pt}] (anchor-3) -- (anchor-2) node [midway,sloped,above=1.25em] {\scshape second layer};
% 
% 
% 
